 ...
 */
case class Event(
  startDate: LocalDate = Constants._1970,
...
object Event extends JodaDateFieldFormat {
  implicit val eventReads: Reads[Event] = (
    ...
    (JsPath \ "recurrenceType").read[RecurrenceType])(Event.apply _)
  ...
  implicit val eventWrites: Writes[Event] = (
    ...
    (JsPath \ "recurrenceType").write[RecurrenceType])(unlift(Event.unapply))
}